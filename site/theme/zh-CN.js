module.exports = {
  ...
  messages: {
    ...
    "app.home.introduce":
      "IGOOANA Landing 平台拥有丰富的各类首页模板，下载模板代码包，即可快速使用，也可使用首页编辑器，快速搭建一个属于你的专属首页",
    ...
    "app.home.edit-slogen":
      "所有模板与模块都基于 IGOOANA 设计规范设计，你可以直接下载我们的模板和源文件，也可使用我们的编辑器，快速搭建一个属于你的专属首页",
    "app.home.slogan": "IGOOANA Landing 模板与规范",
