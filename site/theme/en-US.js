module.exports = {
  ...
  messages: {
    ...
    "app.home.introduce":
      "IGOOANA Landing platform has a variety of  templates, download template package, you can use it quickly, you can also use the  editor to quickly build a dedicated page for you.",
    ...
    "app.home.edit-slogen":
      "All templates and modules are based on IGOOANA specifications. You can download templates and source files directly, or use editor to quickly build a page belonging to you.",
    "app.home.slogan": "IGOOANA Landing Templates and Specifications",
