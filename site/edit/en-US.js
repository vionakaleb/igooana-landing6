module.exports = {
  ...
  messages: {
    ...
    "app.header.publish-cloud.remarks":
      "We don't open the domain name binding function. If there is a requirement, we can leave a message on issues.",
    "app.header.publish-cloud.remarks2":
      "It will take about 2 to 3 minutes for the release and deployment. Please wait patiently.",
    "app.header.publish-cloud.meta": "Page Meta Configuration",
    "app.header.publish-cloud.favicon":
      "The icon of the website only supports ico, PNG or jpg. It is recommended to use png.",
    "app.header.publish-cloud.build":
      "Your website is being publish. Please wait a moment...",
    "app.header.publish-cloud.state": "Current State:",
    "app.header.publish-cloud.success": "Publish Succeeded",
    "app.header.publish-cloud.successRemarks":
      "Your website has been publish succeeded, URL:",
    "app.header.publish-cloud.error": "Publish Error!!!",
    "app.header.publish-cloud.currentURL":
      "If the publication is successful, visit the URL: ",
    "app.header.edit-data": "Edit data",
    "app.header.edit-data.header": "Current edit data",
    "app.header.edit-data.remarks":
      "Paste the downloaded JSON here, please don't change the data. Please refresh if the data is wrong.",
    "app.header.edit-data.download": "Download JSON",
    "app.header.clear-cache": "Clear cache",
    "app.header.clear-exp":
      "Clear all caches and re-read the last saved data from the server;",
    "app.header.new-file.header": "Recently built",
    "app.header.new-file.message": "Data has been refreshed.",
    "app.header.new-file.message2":
      "Data has been refreshed. Current template is not the template you refreshed. Please switch it yourself.",
    ...
    "app.side.encryption.remarks":
      "After setting the password, editing this page requires a password to edit.",
    "app.side.encryption.remarks2":
      "After confirming, please remember to save, otherwise it will be invalid!!!",
    "app.side.encryption.message": "Encryption is successful, please save.",
    "app.side.decrypt.message":
      "Password is successfully deleted, please save it.",
    ...
    "app.other.full.remark":
      "This feature requires saving to generate a preview view.",
    ...
    "app.edit.overpack.always.remark":
      "Repeat with scrolling, each time you scroll to the specified area, there will be an animation.",
    "app.edit.overpack.replay": "Replay",
    "app.edit.overpack.replay.remark":
      "When scrolling to playsScale, when scrolling down or up, it will animate, closing it side only when scrolling down.",
    "app.edit.overpack.play-scale": "Play scale",
    "app.edit.overpack.play-scale.remark":
      "The element enters the specified area of ​​the screen to start the animation, 0.5 is the middle of the screen. [enter, leave].",
    ...
    "app.edit.banner-anim.auto-play-speed.remark":
      "Auto play time, default is 5000 ms",
    ...
    "app.edit.col.remark":
      "Here is the antd grid layout, please don't feel free to change the width of the style below, please modify the grid here",
    ...
    "app.state.drag":
      "Drag here or click the button on the right to change position",
    ...
    "app.state.link.icon.remarks": "Only support IGOOANA icon.",
    "app.state.menu.header": "Edit Nav",
    "app.state.menu.edit.link.header": "Modify link url",
    "app.state.menu.type-link.remark":
      'This navigation is Link navigation. Please fill in the following id name in the link ("a" label will be used if link is filled in);',
    ...
    "app.login.noPassword":
      "If you don't know the password, please delete current page or create a new page",
    "app.login.new": "New Page",
    "app.layout.notification.title": "Editor update description",
    "app.layout.notification.content":
      "In order to improve the performance and experience of editing, the style editing is currently triggered by pressing enter or leaving the input box.",
  },
};
