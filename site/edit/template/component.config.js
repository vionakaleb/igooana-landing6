...
export default {
  ...
  BannerAnim: {
      ...
      props: {
        children: [
          ...
          },
          {
            key: "acrossOverlay",
            name: (
              <FormattedMessage id="app.edit.banner-anim.type.across-overlay" />
            ),
          },
          {
            key: "verticalOverlay",
            name: (
              <FormattedMessage id="app.edit.banner-anim.type.vertical-overlay" />
            ),
          },
          {
            key: "gridBar",
    ...
    autoPlaySpeed: {
      ...
      type: "inputNumber",
      remark: (
        <FormattedMessage id="app.edit.banner-anim.auto-play-speed.remark" />
      ),
    },
    sync: {
          ...
          children: {
            ...
            children: [
              ...
              },
              {
                ...
                children: "Integrated Tools for Data Analysis",
              },
            ],
          },
        },
